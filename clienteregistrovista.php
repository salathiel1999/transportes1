    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">REGISTRO CLIENTE</h3>
            </div>
        </div>
    </div>
    <!-- Header End -->
...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            // Preparar la consulta SQL para seleccionar todos los registros de la tabla 'clientes'
            $sql = "SELECT * FROM clienteboleto";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td>" . $row['idclienteboleto'] . "</td>";
